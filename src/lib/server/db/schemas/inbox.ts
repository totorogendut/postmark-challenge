...
export const mail = sqliteTable(
	"mail",
	{
		...
		fraudIndicator: integer("fraud_indicator").$default(() => 0),
		spamIndicator: integer("spam_indicator").$default(() => 0),
	...
	(t) => [
		...
		index("fraud_indicator_idx").on(t.fraudIndicator),
		index("spam_indicator_idx").on(t.spamIndicator),
